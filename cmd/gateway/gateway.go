...
import (
	...
	// NAS
	_ "github.com/as-polyakov/minio/cmd/gateway/nas"

	// Azure
	_ "github.com/as-polyakov/minio/cmd/gateway/azure"

	// S3
	_ "github.com/as-polyakov/minio/cmd/gateway/s3"

	// HDFS
	_ "github.com/as-polyakov/minio/cmd/gateway/hdfs"

	// GCS (use only if you must, GCS already supports S3 API)
	_ "github.com/as-polyakov/minio/cmd/gateway/gcs"
