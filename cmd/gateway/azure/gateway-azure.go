...
import (
	...
	"github.com/as-polyakov/minio/pkg/bucket/policy/condition"
	sha256 "github.com/minio/sha256-simd"

	minio "github.com/as-polyakov/minio/cmd"
)
...
func (a *azureObjects) ListObjects(ctx context.Context, bucket, prefix, marker, delimiter string, maxKeys int) (result minio.ListObjectsInfo, err error) {
	...
	for len(objects) == 0 && len(prefixes) == 0 {
		...
		for _, blob := range resp.Segment.BlobItems {
			...
			//
			// Some applications depend on this behavior refer https://github.com/as-polyakov/minio/issues/6550
